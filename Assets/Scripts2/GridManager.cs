...
public class GridManager : MonoBehaviour {
    ...
    public void DebugDrawGrid(Vector3 origin,int numRows,int numCols,float cellSize,Color color)
    {
        ...
        {
            Vector3 startPos = origin + i * cellSize * new Vector3(0, 0, 1f);
            Vector3 endPos = startPos + width * new Vector3(1f, 0, 0);
            Debug.DrawLine(startPos, endPos, color);
        }
        for (int i = 0; i < numCols+1; i++)
        {
            Vector3 startPos = origin + i * cellSize * new Vector3(1f, 0, 0);
            Vector3 endPos = startPos + height * new Vector3(0, 0, 1f);
            Debug.DrawLine(startPos, endPos, color);
        }
    }
}
